...
export default function JuanDashboard() {
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      await usersAPI.update(editingUser._id, editUserData);
      setEditingUser(null);
      setEditUserData({});
      loadData();
    } catch (error) {
                            ...
                            <button
                              onClick={() => {
                                ...
                                setEditUserData({
                                  ...
                                  captureCount: user.captureCount,
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 max-w-md w-full glow-purple">
            ...
            <form onSubmit={handleUpdateUser} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  value={editUserData.captureCount || 0}
                  onChange={(e) =>
                    setEditUserData({
                      ...editUserData,
                      captureCount: parseInt(e.target.value) || 0,
                    })
                  }
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={editUserData.isVictim || false}
                    onChange={(e) =>
                      setEditUserData({
                        ...editUserData,
                  ...
                  />
                  <span className="text-sm">Mark as Victim</span>
                </label>
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  value={editUserData.reward || ""}
                  onChange={(e) =>
                    setEditUserData({ ...editUserData, reward: e.target.value })
                  }
